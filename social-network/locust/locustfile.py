...
####################################################################################################################################
GLOBAL_NGINX_FRONTEND_URL  = 'http://nginx-thrift-social-network.apps.aiops.os.fyre.ibm.com'
GLOBAL_MEDIA_FRONTEND_URL  = 'http://media-frontend-social-network.apps.aiops.os.fyre.ibm.com'

GLOBAL_EXPERIMENT_DURATION = None    # None = Run forever, 43200 = 12 hour
GLOBAL_SECONDS_PER_DAY     = 3600    # 3600 = 1 hour
GLOBAL_MIN_USERS           = 100
GLOBAL_PEAKS               = [350, 400, 450, 500]
GLOBAL_RANDOMNESS          = 0.20
GLOBAL_WAIT_TIME           = between(1, 3)
GLOBAL_COMPOSITIONS        = [(20, 60, 20), (35, 50, 15), (40, 50, 10), (40, 40, 20), (25, 60, 15), (30, 60, 10), (30, 50, 20), (40, 45, 15), (25, 50, 25), (35, 40, 25), (25, 45, 30), (20, 55, 25), (20, 50, 30), (30, 55, 15), (35, 55, 10), (35, 45, 20), (25, 55, 20), (30, 45, 25), (30, 40, 30)]
